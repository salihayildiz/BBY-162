...
kelime = random.choice(['etik', 'saygı', 'dünya', 'emek', 'azim', 'sevgi', 'gökyüzü'])
        ...
        if len(alinanHarf) > 1:
            ...
            if alinanHarf in harfHavuzu:
                ...
                for i in range(len(kelime)):
                    ...
                    if alinanHarf == kelime[
                        i]:  ## kullanıcının girdiği harf, bulunucak kelimenin "i" nin taşıdığı sayı değerindeki indexteki harfe eşit ise
                        bulduk = True
